...
| F3 | Factory pay trails peers but labour's share of GVA is higher than every comparator ("larger slice of a smaller pie") | Emoluments per paid person: TN ₹316,681; IN −51,520, GJ −53,449, MH −180,831, KA −133,026, TG +29,455, KL −26,689. Labour-cost-proxy share of GVA: TN 43.3%, +7.4 to +12.1pp vs all six comparators. TN's pay advantage over TG is 97% industry mix. Direction corroborated by TN Economic Survey 2025–26 §4.3 AND by official ASI 2023-24 totals (TN emoluments/GVA 37.4% official vs our 37.6%); but the ES's levels (15%/30%) do NOT reconcile with official ASI totals — cite ES for direction only, never levels (EXTERNAL_VALIDATION.md §5) | Wage/job-quality relevance of investment and sector instruments | Headline |
