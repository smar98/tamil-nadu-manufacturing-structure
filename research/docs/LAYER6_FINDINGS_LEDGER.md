...
|---|---|---|---|---|
| F1 | No obvious missing middle under the tested definitions and peer set | Layer 1/2 diagnostic; TN 10–249 employment share not abnormally low vs peers | Additional capital subsidy for scaling up | Headline |
